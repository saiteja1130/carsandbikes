...
import { FiMapPin, FiPhone, FiClock, FiAward, FiUsers, FiTool, FiShield, FiStar } from "react-icons/fi";
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black pt-16 sm:pt-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-tech font-black text-white mb-4 sm:mb-6">
              About <span className="text-red-500">FixinMoto</span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl font-modern text-gray-300 leading-relaxed">
              Your trusted destination for premium car detailing and expert bike repair services
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              ...
              <motion.div variants={itemVariants}>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-tech font-black text-white mb-4 sm:mb-6">
                  Welcome to <span className="text-red-500">FixinMoto</span>
                </h2>
                <p className="text-base sm:text-lg font-modern text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                  We're passionate about delivering precision, care, and perfection — one vehicle at a time.
                </p>
                <p className="text-base sm:text-lg font-modern text-gray-300 mb-6 sm:mb-8 leading-relaxed">
                  At FixinMoto, we combine advanced technology, high-quality products, and skilled craftsmanship to give your car or bike a fresh, flawless finish inside and out. From deep-clean detailing and ceramic coating to engine tune-ups and performance upgrades, every service we offer is designed to enhance your vehicle's appearance, protection, and performance.
                </p>
                <div className="flex flex-wrap gap-3 sm:gap-4 mt-6 sm:mt-8">
                  {stats.map((stat, index) => (
                    <div key={index} className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-xl border border-red-500/20 flex-1 min-w-[120px]">
                      <div className="text-xl sm:text-2xl font-tech font-bold text-red-500">{stat.number}</div>
                      <div className="text-gray-300 font-modern text-xs sm:text-sm">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-red-500/20">
                  <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-industrial font-bold text-white">Our Mission</h3>
                  </div>
                  <p className="text-gray-300 font-modern leading-relaxed">
                    To redefine vehicle care by providing exceptional detailing and repair services that exceed customer expectations, ensuring every ride looks stunning and runs smoothly.
                  </p>
                </div>
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-red-500/20">
                  <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-industrial font-bold text-white">Our Vision</h3>
                  </div>
                  <p className="text-gray-300 font-modern leading-relaxed">
                    To become the most trusted name in auto detailing and two-wheeler repair, known for innovation, reliability, and unmatched service quality.
                  </p>
                </div>
              </motion.div>
            </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-800/20">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-tech font-black text-white mb-4 sm:mb-6">
              Why Choose <span className="text-red-500">FixinMoto</span>
            </h2>
            <p className="text-lg sm:text-xl font-modern text-gray-300 max-w-2xl mx-auto px-4">
              We're committed to delivering exceptional service with unmatched quality
            </p>
          </motion.div>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-industrial font-bold text-white mb-2 sm:mb-4">{feature.title}</h3>
                <p className="text-gray-300 font-modern text-sm sm:text-base leading-relaxed">{feature.description}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl sm:text-2xl font-industrial font-bold text-white text-center mb-4 sm:mb-6">Our Commitment</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6 text-gray-300">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="font-modern text-sm sm:text-base">Transparent pricing with no hidden costs</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <FiStar className="text-red-500 flex-shrink-0 text-sm sm:text-base" />
                <span className="font-modern text-sm sm:text-base">Customer satisfaction guaranteed</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <FiStar className="text-red-500 flex-shrink-0 text-sm sm:text-base" />
                <span className="font-modern text-sm sm:text-base">Emergency services available 24/7</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <FiStar className="text-red-500 flex-shrink-0 text-sm sm:text-base" />
                <span className="font-modern text-sm sm:text-base">Free consultation and estimates</span>
              </div>
            </div>
          </motion.div>
        </div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-800/50 rounded-xl sm:rounded-2xl border border-red-500/20">
                  ...
                  <div>
                    <h3 className="text-white font-industrial font-semibold text-base sm:text-lg">Address</h3>
                    <p className="text-gray-300 font-modern text-sm sm:text-base">{branchInfo.address}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-800/50 rounded-xl sm:rounded-2xl border border-red-500/20">
                  ...
                  <div>
                    <h3 className="text-white font-industrial font-semibold text-base sm:text-lg">Phone</h3>
                    <p className="text-gray-300 font-modern text-sm sm:text-base">{branchInfo.phone}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-800/50 rounded-xl sm:rounded-2xl border border-red-500/20">
                  ...
                  <div>
                    <h3 className="text-white font-industrial font-semibold text-base sm:text-lg">Working Hours</h3>
                    <p className="text-gray-300 font-modern text-sm sm:text-base">{branchInfo.hours}</p>
                  </div>
                </div>
              </div>
              ...
              >
                <p className="text-gray-300 font-modern text-base sm:text-lg leading-relaxed">
                  At FixinMoto, we treat every vehicle like our own — with precision, passion, and professionalism. Whether it's restoring your car's showroom shine or keeping your bike road-ready, we're here to make your ride stand out.
                </p>
              </motion.div>
            </motion.div>

            {/* Map */}
            <motion.div variants={itemVariants} className="bg-gray-800/50 rounded-xl sm:rounded-2xl overflow-hidden border border-red-500/20">
